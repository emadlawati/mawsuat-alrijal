...
T = {
    ...
    'home.intro1': {'ar': '🔎 تصفّح حال <b>{n}</b> راوٍ مع جميع آراء علماء الرجال فيه',
                    'en': '🔎 Browse the status of <b>{n}</b> narrators with all the rijāl scholars’ opinions'},
    'home.intro2': {'ar': '📚 تصفّح كتب الرجال كاملةً مع خاصيّة البحث في نصوصها',
                    'en': '📚 Browse the full rijāl books with full-text search'},
    'home.intro3': {'ar': '🔗 تحليل الأسانيد والحكم عليها بأضعف رواتها',
                    'en': '🔗 Analyze chains and grade them by their weakest narrator'},
    'home.intro4': {'ar': '📊 دراساتٌ بحثيّة في الأسانيد: العلل، المشيخة وطرق الكتب، وشبكة الرواة',
                    'en': '📊 Research studies on the chains: defects, mashyakha & book-paths, narrator network'},
    ...
    'lib.search.ph': {'ar': 'مثال: زرارة بن أعين', 'en': 'e.g. Zurāra b. Aʿyan'},
